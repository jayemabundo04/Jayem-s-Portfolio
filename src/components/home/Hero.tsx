...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-line bg-ink">
      ...
      <div className="mx-auto flex min-h-[36rem] w-full max-w-6xl items-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase text-emerald-200">Web Developer & UI/UX Designer</p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-100">
            I create responsive interfaces and full-stack application foundations with a focus on usability,
            maintainable code, and clear product thinking.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-2" aria-label="Current technology focus">
            {stackItems.map((item) => (
              <span
